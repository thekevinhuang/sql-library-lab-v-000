...
def select_name_and_series_subgenres_of_authors
  "SELECT authors.name, series.title, subgenres.name FROM authors JOIN series ON series.author_id = author.id JOIN subgenres ON series.subgenre_id = subgenres.id;"
end
